...
######خودم
print('current_device1=',torch.cuda.current_device())
print('cuda.memory_allocated1=',torch.cuda.memory_allocated())
print('cuda.max_memory_allocated1',torch.cuda.max_memory_allocated())
print('cuda.memory_reserved1=',torch.cuda.memory_reserved())
print('cuda.max_memory_reserved1=',torch.cuda.max_memory_reserved())
print('cuda.memory_stats1=',torch.cuda.memory_stats())
print('cuda.memory_snapshot1=',torch.cuda.memory_snapshot())
print('cuda.memory_summary1=',torch.cuda.memory_summary())
...
def entry(rank, config, resume, only_validation):
    ...
    torch.distributed.init_process_group(backend="nccl")# mpi#################################
